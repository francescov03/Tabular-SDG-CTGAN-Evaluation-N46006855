...
syn_df = pd.read_csv("../dataset/bank_synthetic.csv")
...
for col in numerical_cols:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"../output/hist_{col}_50epoche.png")
    plt.close()
...
for col in categorical_cols:
    ...
    plt.tight_layout()
    plt.savefig(f"../output/bar_{col}_50epoche.png")
    plt.close()
...
plt.tight_layout()
plt.savefig("../output/heatmap_reale_50epoche.png")
plt.close()
...
plt.tight_layout()
plt.savefig("../output/heatmap_sintetico_50epoche.png")
plt.close()
