...
```bash
git clone [https://github.com/tuo-username/Tabular-SDG-CTGAN-Evaluation-N46006855.git](https://github.com/tuo-username/Tabular-SDG-CTGAN-Evaluation-N46006855.git)
